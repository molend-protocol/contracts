...
abstract contract MolendtrollerInterface {
    /// @notice Indicator that this is a Molendtroller contract (for inspection)
    bool public constant isMolendtroller = true;
