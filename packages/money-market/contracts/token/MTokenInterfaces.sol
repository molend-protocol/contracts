...
contract MTokenStorage {
     ...
     */
    MolendtrollerInterface public molendtroller;
...
abstract contract MTokenInterface is MTokenStorage {
    ...
    /**
     * @notice Event emitted when molendtroller is changed
     */
    event NewMolendtroller(MolendtrollerInterface oldMolendtroller, MolendtrollerInterface newMolendtroller);
    ...
    function _setMolendtroller(MolendtrollerInterface newMolendtroller) external virtual returns (uint);
